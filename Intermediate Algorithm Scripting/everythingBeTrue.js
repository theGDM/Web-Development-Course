...
function truthCheck(collection, pre) {
    //get all the values of predicate, in an array
    let tempArray = collection.map(function (object) {
        return object[pre];
    });

    //if any of the value stored in tempArray is falsy we would get false
    let res = tempArray.every(function (item) {
